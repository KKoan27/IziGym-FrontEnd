        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              // Logo IziGym (Substitua por Image.asset('assets/izigym_logo.png') após adicionar o asset)
              Container(
                width: 150,
                height: 150,
                color: Colors.transparent, // Apenas um placeholder visual
                child: const Center(
                  child: Text(
                    'iG\nIziGym',
